...
export const Locationregister = () => {
  return (
    <div className='bg-slate-400'>
      <p className='text-[30px] text-center text-black pt-24'>Location Owner Regestration</p>
   <form className='pt-5  w-[30%] text-center m-auto '>

      <input type="text" className='text-black mb-3 p-2 w-[100%]  border-2 bg-transparent rounded placeholder-gray-950 border-slate-700' placeholder='Owner Name' />
      ...
      <p className='text-start'>ID Proof</p>
      <input type="file" />

...
export const Hiringreq = () => {
  return (
    <div className='hcreq'>
    <div className='text-white pt-48 text-center mb-3'> HIRING COMPANY</div>
...
<form class="max-w-lg mx-auto h-5">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700/50">
        ...
        <div class="relative w-full">
            ...
            <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium h-full text-white bg-gray-700/50 rounded-e-lg border border-blue-700 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-950/50 dark:hover:bg-gray-700-700 dark:focus:ring-blue-800/50">

    ...
    <div className='addanc flex flex-wrap flex-col'>
         ...
         <div className='m-auto w-fit '>
          <div className='flex  flex-row pb-3 flex-wrap justify-center'>
            ...
            <input onChange={handleChange} required name='Filmname' type="text" placeholder='Film Name' className='w-[80%] bg-transparent  placeholder:text-white border-2 rounded placeholder:text-[20px] border-white text-white h-9 placeholder:text-center' />
          </div>
          <div className='flex  flex-row  flex-wrap pb-3 justify-center'>
            
            <input onChange={handleChange} required name='Director' pattern="^[a-zA-Z ]*$" type="text" placeholder='Director' className='w-[80%] bg-transparent  placeholder:text-white border-2 rounded placeholder:text-[20px] border-white text-white h-9 placeholder:text-center' />
          </div>
